...
def guardar_datos():
    global nombre1, apellido1, edad1, correo1, telefono1
    datos = {'Nombres':nombre1,'Apellido':apellido1,'Edad':edad1,'Correo':correo1,'Telefono':telefono1}
    nom_excel = str(nombre_archivo.get() + ".xlsx")
    df = pd.DataFrame(datos,columns = ['Nombres','Apellido','Edad','Correo','Telefono'])
